...
- (void)initControlBtn {
    self.controlView = [[UIView alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 70.0f, self.view.bounds.size.width, 70)];
    self.controlView.backgroundColor = [UIColor colorWithRed:50.0f/255.0f green:50.0f/255.0f blue:50.0f/255.0f alpha:0.4f];
    self.controlView.autoresizingMask = UIViewAutoresizingNone;
    [self.view addSubview:self.controlView];
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 70.0f, 100, 70)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - 70.0f, 100, 70)];
